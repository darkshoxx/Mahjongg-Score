...
#yonin=matrix(NA,0,9)
#colnames(zombie)<-c("id","day","month","year","Daniel","Andreas","Theresa","Tobi","Zombie","Kasumi")
...
if(tsum>0.01){print("ERRORSUM");break()}else{print(tsum)}
